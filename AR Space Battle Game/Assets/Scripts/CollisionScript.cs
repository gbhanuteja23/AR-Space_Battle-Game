...
public class CollisionScript : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        if (GameObject.FindGameObjectsWithTag("Player").Length == 0)
        {
            ...
            GameObject enemy2 = Instantiate(Resources.Load("enemy1", typeof(GameObject))) as GameObject;
            GameObject enemy3 = Instantiate(Resources.Load("enemy1", typeof(GameObject))) as GameObject;
